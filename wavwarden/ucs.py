...
This module intentionally implements wavwarden's current UCS heuristic, not a
...
from wavwarden.models import UcsParseResult
...
def parse_ucs_stem(stem: str) -> UcsParseResult:
    """Parse a stem with wavwarden's UCS-looking-name heuristic."""
