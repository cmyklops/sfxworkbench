...
from wavwarden.models import MetadataViewFile, MetadataViewReport, MetadataViewTag, MetadataViewUcs
...
def build_metadata_view_report(
    ...
    *,
    ...
    rows, tags_by_file = _load_matching_file_rows(db_path, query, limit)
