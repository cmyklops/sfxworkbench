...
_LABELS: dict[str, str] = {
    ...
    "scan-full-audit": "Smart full audit",
    "scan-audit-reuse-index": "Reuse indexed data for audit",
    "scan-audit-full": "Full scan / full audit",
    "scan-force-rescan": "Force rescan",
    ...
    "dedupe-build": "Smart dedupe plan",
    "dedupe-reuse-index": "Reuse indexed data for dedupe",
    "dedupe-rebuild": "Rebuild dedupe plan",
    "dedupe-apply": "Apply dedupe (quarantine)",
    "pack-audit": "Smart pack audit",
    "pack-audit-reuse-index": "Reuse indexed data for pack audit",
    "pack-audit-rebuild": "Rebuild pack audit",
    "pack-plan": "Smart pack plan",
    "pack-plan-reuse-index": "Reuse indexed data for pack plan",
    "pack-plan-rebuild": "Rebuild pack plan",
    ...
    "metadata-audit": "Smart metadata audit",
    "metadata-audit-reuse-index": "Reuse indexed data for metadata audit",
    "metadata-audit-refresh": "Refresh metadata only",
    "metadata-plan": "Smart find tags",
    "metadata-plan-reuse-index": "Reuse indexed metadata for tags",
    "metadata-plan-rebuild": "Rebuild tag plan",
